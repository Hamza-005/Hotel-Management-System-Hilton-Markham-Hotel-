...
public class AdminServiceEdit extends JFrame {
    ...
    public AdminServiceEdit(InstanceClassServices service) {
        super("Edit Service");
        ...
        idTextField.setText(String.valueOf(service.getId()));
        ...
        updateBtn.setBounds(432, 519, 263, 67);
        ...
        updateBtn.addActionListener(e -> {
            ...
            if (id.isEmpty() || name.isEmpty() || description.isEmpty() || price.isEmpty()){
                ...
                try {
                    InstanceClassServices updatedService = new InstanceClassServices(Integer.parseInt(id), Double.parseDouble(price), name, description);
                    if (Resources.dataBase.updateService(updatedService)){
                        JOptionPane.showMessageDialog(null, "Service Updated successfully");
                        new AdminServiceShowAll().setVisible(true);
                        dispose();
                    }
                    else {
                        JOptionPane.showMessageDialog(null, "Error in Updating service");
                    }
