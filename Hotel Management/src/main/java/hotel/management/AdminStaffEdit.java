...
public class AdminStaffEdit extends JFrame {
    ...
    public AdminStaffEdit(InstanceClassStaff staff) {
        ...
        roleComboBox.setSelectedItem(staff.getPosition());
        ...
        saveBtn.addActionListener(e -> {
            ...
            if (id.isEmpty() || password.isEmpty() || fullName.isEmpty() || address.isEmpty() || email.isEmpty() || phone.isEmpty() || salary.isEmpty()) {
                ...
                InstanceClassStaff updatedStaff = new InstanceClassStaff(Integer.parseInt(id), password, fullName, selectedRole, Integer.parseInt(salary), address, phone, email);
