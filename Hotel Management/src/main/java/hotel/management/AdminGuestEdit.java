...
public class AdminGuestEdit extends JFrame {
    ...
    public AdminGuestEdit(InstanceClassGuest guest) {
        super("Guest Signup");
        ...
        idTextField.setText(String.valueOf(guest.getId()));
        ...
        countryComboBox.setSelectedItem(guest.getNationality());
        ...
        fullNameTextField.setText(guest.getName());
        ...
        passwordTextField.setText(guest.getPassword());
        ...
        phoneTextField.setText(guest.getPhoneNumber());
        ...
        addressTextArea.setText(guest.getAddress());
        ...
        saveBtn.addActionListener(e -> {
            ...
            if (idTextField.getText().isEmpty() || fullNameTextField.getText().isEmpty() || passwordTextField.getPassword().length == 0 || addressTextArea.getText().isEmpty() || emailTextField.getText().isEmpty() || phoneTextField.getText().isEmpty()) {
                ...
                InstanceClassGuest updatedGuest = new InstanceClassGuest(id, password, fullName, country, address, phone, email);
                connection.updateGuest(updatedGuest);

                JOptionPane.showMessageDialog(null, "Guest Successfully updated");
                new AdminGuestShowAll().setVisible(true);
                dispose();
            }
        });
