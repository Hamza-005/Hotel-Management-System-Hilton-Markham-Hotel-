...
public class AdminRoomEdit extends JFrame {
    ...
    public AdminRoomEdit(InstanceClassRoom room) {
        super("Edit room");
        ...
        idTextField.setText(String.valueOf(room.getRoomID()));
        ...
        rateTextField.setText(String.valueOf(room.getRate()));
        ...
        availabilityComboBox.setSelectedItem(String.valueOf(room.isAvailable()));
        ...
        saveBtn.addActionListener(e -> {
            ...
            if (id.isEmpty() || rate.isEmpty()) {
                ...
                try {
                    InstanceClassRoom updated = new InstanceClassRoom(Integer.parseInt(id), selectedType, Integer.parseInt(rate), Boolean.parseBoolean(selectedAvailability));
                    if (Resources.dataBase.updateRoom(updated)){
