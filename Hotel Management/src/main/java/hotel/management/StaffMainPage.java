...
public class StaffMainPage extends JFrame {
	...
	public StaffMainPage() {
		...
		imageButton1.setBounds(297, 257, 207, 192);
		contentPane.add(imageButton1);
		imageButton1.addActionListener(e -> {
			new StaffMyInfoPage().setVisible(true);
			dispose();
		});
		
		ImageIcon iconOriginal2 = new ImageIcon("res/iconMyServices.png");
		...
		imageButton2.setBounds(616, 257, 207, 192);
